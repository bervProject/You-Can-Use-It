 ...
 */
package main.youcanuseit.screens.tutorial.hardware {
...
public class HardwareTutorial extends PanelScreen {
    /** List of Hardware Tutorial Menu. */
    ...
    public function HardwareTutorial() {
        super();
    }
    ...
    override protected function initialize():void {
        ...
        this.title = "Hardware Tutorial";

        this.layout = new AnchorLayout();

        this._list = new List();
        this._list.dataProvider = new ListCollection([
            {label: "Turn On Computer", screen: ScreenID.TURN_ON_COMPUTER },
            {label: "Turn On Smartphone", screen: ScreenID.TURN_ON_SMARTPHONE },
        ]);

 ...
 */
package main.youcanuseit.screens.tutorial.windows {
...
public class WindowsTutorial extends PanelScreen {

    /** List of Windows Tutorial Menu. */
    ...
    public function WindowsTutorial() {
        super();
    }
    ...
    override protected function initialize():void {
        ...
        this.title = "Windows Tutorial";

        this.layout = new AnchorLayout();

        this._list = new List();
        this._list.dataProvider = new ListCollection([
            {label: "Shutdown Tutorial", screen: ScreenID.WINDOWS_SHUTDOWN},
            {label: "Opening File Tutorial", screen: ScreenID.WINDOWS_OPENING_FILE},
        ]);

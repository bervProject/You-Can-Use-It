 ...
 */
package main.youcanuseit.screens.tutorial.android {
...
public class AndroidTutorial extends PanelScreen {
    /** List of Android Tutorial Menu. */
    ...
    public function AndroidTutorial() {
        super();
    }
    ...
    override protected function initialize():void {
        ...
        this.title = "Android Tutorial";

        this.layout = new AnchorLayout();

        this._list = new List();
        this._list.dataProvider = new ListCollection([
            {label: "Shutdown Tutorial", screen: ScreenID.ANDROID_SHUTDOWN },
            {label: "Opening File Tutorial", screen: ScreenID.ANDROID_OPENING_FILE },
        ]);

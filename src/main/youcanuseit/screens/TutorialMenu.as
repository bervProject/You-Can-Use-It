...
public class TutorialMenu extends PanelScreen {

    /** List of Tutorial Menu. */
    ...
    override protected function initialize():void {
        ...
        this._list.dataProvider = new ListCollection([
            {label: "Windows", screen: ScreenID.WINDOWS_TUTORIAL },
            {label: "Linux", screen: ScreenID.LINUX_TUTORIAL },
            {label: "Android", screen: ScreenID.ANDROID_TUTORIAL },
            {label: "Hardware", screen: ScreenID.HARDWARE_TUTORIAL },
        ]);
